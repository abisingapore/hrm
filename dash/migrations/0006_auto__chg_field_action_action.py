...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.action'
        db.alter_column(u'dash_action', 'action', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'Action.action'
        db.alter_column(u'dash_action', 'action', self.gf('django.db.models.fields.TextField')())
