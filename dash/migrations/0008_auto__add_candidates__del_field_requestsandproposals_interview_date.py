...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dash_candidates', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='Proposed', max_length=50)),
        ))
        db.send_create_signal(u'dash', ['Candidates'])

        # Deleting field 'RequestsAndProposals.interview_date'
        db.delete_column(u'dash_requestsandproposals', 'interview_date')
    ...
    def backwards(self, orm):
        # Deleting model 'Candidates'
        db.delete_table(u'dash_candidates')

        # Adding field 'RequestsAndProposals.interview_date'
        db.add_column(u'dash_requestsandproposals', 'interview_date',
