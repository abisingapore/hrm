...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidates.title_proposed'
        db.add_column(u'dash_candidates', 'title_proposed',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidates.title_proposed'
        db.delete_column(u'dash_candidates', 'title_proposed')
    ...
    models = {
        ...
        u'dash.candidates': {
            ...
            'title_proposed': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
