...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.language_proficiency'
        db.add_column(u'webform_applicant', 'language_proficiency',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Applicant.computer_literacy'
        db.add_column(u'webform_applicant', 'computer_literacy',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.language_proficiency'
        db.delete_column(u'webform_applicant', 'language_proficiency')

        # Deleting field 'Applicant.computer_literacy'
        db.delete_column(u'webform_applicant', 'computer_literacy')
    ...
    models = {
        u'webform.applicant': {
            ...
            'language_proficiency': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
