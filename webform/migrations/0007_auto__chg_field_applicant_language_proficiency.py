...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.language_proficiency'
        db.alter_column(u'webform_applicant', 'language_proficiency', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.language_proficiency'
        db.alter_column(u'webform_applicant', 'language_proficiency', self.gf('django.db.models.fields.TextField')(null=True))
