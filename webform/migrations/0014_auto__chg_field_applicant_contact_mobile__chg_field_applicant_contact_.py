...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.contact_mobile'
        db.alter_column(u'webform_applicant', 'contact_mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(default='phone number', max_length=128))

        # Changing field 'Applicant.contact_home'
        db.alter_column(u'webform_applicant', 'contact_home', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Applicant.contact_mobile'
        db.alter_column(u'webform_applicant', 'contact_mobile', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Applicant.contact_home'
        db.alter_column(u'webform_applicant', 'contact_home', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        u'webform.applicant': {
            ...
            'contact_home': ('phonenumber_field.modelfields.PhoneNumberField', [], {'max_length': '128', 'blank': 'True'}),
