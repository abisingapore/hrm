...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'webform_applicant', 'contact_home', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.contact_home'
        db.alter_column(u'webform_applicant', 'contact_home', self.gf('phonenumber_field.modelfields.PhoneNumberField')(default=' ', max_length=128))
