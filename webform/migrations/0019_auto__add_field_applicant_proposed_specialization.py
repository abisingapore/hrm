...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.proposed_specialization'
        db.add_column(u'webform_applicant', 'proposed_specialization',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.proposed_specialization'
        db.delete_column(u'webform_applicant', 'proposed_specialization')
