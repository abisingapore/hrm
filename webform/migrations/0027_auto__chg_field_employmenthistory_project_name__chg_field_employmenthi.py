...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmploymentHistory.project_name'
        db.alter_column(u'webform_employmenthistory', 'project_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'EmploymentHistory.responsibilities'
        db.alter_column(u'webform_employmenthistory', 'responsibilities', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EmploymentHistory.project_name'
        raise RuntimeError("Cannot reverse this migration. 'EmploymentHistory.project_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EmploymentHistory.project_name'
        db.alter_column(u'webform_employmenthistory', 'project_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'EmploymentHistory.responsibilities'
        raise RuntimeError("Cannot reverse this migration. 'EmploymentHistory.responsibilities' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EmploymentHistory.responsibilities'
        db.alter_column(u'webform_employmenthistory', 'responsibilities', self.gf('django.db.models.fields.TextField')())
