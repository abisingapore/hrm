...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certification.remarks'
        db.alter_column(u'webform_certification', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Certification.remarks'
        db.alter_column(u'webform_certification', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))
