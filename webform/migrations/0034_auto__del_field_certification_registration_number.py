...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certification.registration_number'
        db.delete_column(u'webform_certification', 'registration_number')


    def backwards(self, orm):
        # Adding field 'Certification.registration_number'
        db.add_column(u'webform_certification', 'registration_number',
