...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webform_applicant', (
            ...
            ('contact_home', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True)),
            ('contact_mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128)),
            ...
            ('proposed_specialization', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ...
        db.create_table(u'webform_certification', (
            ...
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ...
        db.create_table(u'webform_employmenthistory', (
            ...
            ('project_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('position_held', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('responsibilities', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webform.Applicant'])),
        ))
    ...
    models = {
        ...
        u'webform.certification': {
            ...
            'remarks': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
