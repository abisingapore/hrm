...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certification.position'
        db.add_column(u'webform_certification', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certification.position'
        db.delete_column(u'webform_certification', 'position')
    ...
    models = {
        ...
        u'webform.certification': {
            'Meta': {'ordering': "['position']", 'object_name': 'Certification'},
